  ...
  return (
    <>
      <div className={styles.block}>
        <h2>제1조(목적)</h2>
        <p>
          스탁트리(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하
          '회사 서비스')를 이용하는 개인 (이하 '이용자' 또는 '개인')의 정보(이하
          '개인정보)를 보호하기 위해, 개인정보보호법, 정보통신망 이 용촉진 및
          정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고,
          서비스 이용자의 가 인정보 보호 관련한 고충을 신속하고 원활하게 처리할
          수 있도록 하기 위하여 다음과 같이 개인정보처 리방침(이하 '본 방침)을
          수립합니다
        </p>
      </div>
      <div className={styles.block}>
        ...
        <p>
          ...
          수 있으며 수집된 개인정보 는 개인의 동의가 있는 경우에 한해 제3자에게
          제공될 수 있습니다. 단, 법령의 규정 등에 의해 적법하 게 강제되는 경우
      ...
      <div className={styles.block}>
        ...
        <ol>
          ...
          <li>
            ...
            활용하여 이용자가 본 방침을 쉽게 확 인할 수 있도록 합니다.
          </li>
        </ol>
      </div>
      <div className={styles.block}>
      ...
      <div className={styles.block}>
        ...
        <ol>
          ...
          <li>인구통계학적 분석, 서비스 방문 및 이용기록의 분석을 위한 경</li>
        </ol>
      </div>
      <div className={styles.block}>
        ...
        <ol>
          ...
          <li>
            ...
            가입 및 이용 방지를 위하여 회 원 탈퇴 시점으로부터 최대 1년간
            보관합니다.
          </li>
        </ol>
      </div>
      <div className={styles.block}>
        ...
        <ol>
          <li>
            전자상거래 동에서의 소비자보호에 관한 법률에 따른 보유정보 및
            보유기간
            <ol>
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          경과 등 개인정보가 필요하 지 않을 경우에는 해당 정보를 지체 없이
          파기합니다.
        </p>
      </div>
      <div className={styles.block}>
      ...
      <div className={styles.block}>
        ...
        <ol>
          <li>
            ...
            조회하거나 수정할 수 있으며 개인 정보수집 동의 철회를 요청할 수
            있습니다.
          </li>
          <li>
      ...
      <div className={styles.block}>
        ...
        <ol>
          ...
          <li>
            ...
            이용 또는 제공하지 않으며 잘못 된 개인정보를 제3자에게 이미 제공한
      ...
      <div className={styles.block}>
        <h2>제17조(개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항)</h2>
        <ol>
          <li>
      ...
      <div className={styles.block}>
        ...
        <ol>
          <li>
            ...
            처리하기 위하여 아래와 같이 관련 부 서 및 개인정보 보호 책임자를
            지정하고 있습니다.
            <ol>
              <li>
                개인정보 보호 책임자
                <ol>
                  <li>성명: 손민구</li>
                  <li>직책: CEO</li>
                  <li>전화번호: 01031117905</li>
                  <li>이메일: hss5036@gmail.com</li>
                </ol>
              </li>
            </ol>
          </li>
      ...
      <div className={styles.block}>
        <h3>부칙</h3>
        <p>제1조 본 방침은 2024.01.26부터 시행됩니다.</p>
      </div>
    </>
  );
}
